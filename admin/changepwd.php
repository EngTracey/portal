...
<div class="page-heading page-heading-md">
	...
	<?php 
				...
				$client=mysqli_query($conn, "SELECT * FROM admin WHERE username = '$s_id'")or die(mysqli_error());
...
//validation starts
	...
	{
	mysqli_query($conn, "UPDATE admin SET password ='$newpwd' where username='$emid'")or die(mysqli_error($conn)); ?>
	<script>
